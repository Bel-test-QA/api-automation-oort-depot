...
5. После завершения прогона (даже если тесты упадут из-за багов песочницы) внизу страницы билда в секции **Artifacts** будет доступен для скачивания свежий файл `postman-html-report`.
